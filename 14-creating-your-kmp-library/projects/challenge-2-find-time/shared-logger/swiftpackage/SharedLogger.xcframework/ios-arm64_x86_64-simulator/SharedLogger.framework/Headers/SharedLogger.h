...
@interface SharedLoggerBase : NSObject
...
@interface SharedLoggerLogger : SharedLoggerBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)logger __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedLoggerLogger *shared __attribute__((swift_name("shared")));
